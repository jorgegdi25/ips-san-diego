...
export default function FloatingWhatsApp() {
  return (
    <a
      className="fixed bottom-8 right-8 w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform z-[60] text-white"
